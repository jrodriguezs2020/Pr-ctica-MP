...
public class DesafioTest {
    ...
    public void setUp() {
        ...
        personaje3.esbirroList.add(g1);
        personaje3.esbirroList.add(d1);
        personaje3.esbirroList.add(h1);
        ...
        personaje4.esbirroList.add(g1);
        personaje4.esbirroList.add(d1);
        personaje4.esbirroList.add(h1);
