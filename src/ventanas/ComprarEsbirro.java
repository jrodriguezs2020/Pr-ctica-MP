...
public class ComprarEsbirro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabelFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 416, 428));
    ...
    private void jDemonioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jDemonioActionPerformed
        ...
        if (oro<100){
            ...
            NombreEsbirro esbi = new NombreEsbirro(sis, this, jugador, 0);
    ...
    private void jGhoulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jGhoulActionPerformed
        ...
        if (oro<20){
            ...
            this.setVisible(false);
            NombreEsbirro esbi = new NombreEsbirro(sis, this, jugador, 1);
            esbi.setVisible(true);
        }
    ...
    private void jHumanoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jHumanoActionPerformed
        ...
        if (oro<50){
            ...
            this.setVisible(false);
            NombreEsbirro esbi = new NombreEsbirro(sis, this, jugador, 2);
            esbi.setVisible(true);
        }
